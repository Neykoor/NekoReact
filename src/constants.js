...
export const ACTIONS_CONFIG = {
    angry: { aliases: ['enojado', 'rage', 'mad', 'furioso'], support: ['nekosbest', 'otakugifs', 'kyoko', 'hmtai', 'animereactions'], label: 'enfado', emoji: '😠' },
    blush: { aliases: ['sonrojarse', 'shy', 'timido', 'avergonzado'], support: ['nekosbest', 'waifupics', 'otakugifs', 'kyoko', 'hmtai'], label: 'sonrojo', emoji: '😳' },
    bored: { aliases: ['aburrido', 'aburrimiento'], support: ['nekosbest', 'otakugifs', 'kyoko'], label: 'aburrimiento', emoji: '😴' },
    cry: { aliases: ['llorar', 'triste', 'llanto', 'sad'], support: ['nekosbest', 'waifupics', 'otakugifs', 'kyoko', 'hmtai'], label: 'llanto', emoji: '😭' },
    ...
    sad: { aliases: ['tristeza', 'deprimido'], support: ['otakugifs', 'animereactions'], label: 'tristeza', emoji: '😢' },
    ...
    sleep: { aliases: ['dormir', 'cansado', 'sueño'], support: ['nekosbest', 'otakugifs', 'kyoko', 'hmtai'], label: 'sueño', emoji: '😴' },
    ...
    slap: { aliases: ['bofetada', 'cachetada', 'smack'], support: ['nekosbest', 'waifupics', 'otakugifs', 'kyoko', 'hmtai'], label: 'bofetada', emoji: '👋' },
    ...
    cheer: { aliases: ['animar', 'aplaudir', 'yay'], support: OTAKUGIFS_ONLY, label: 'aplauso', emoji: '📣' },
    ...
    mad: { aliases: ['furioso', 'enojado-max'], support: OTAKUGIFS_ONLY, label: 'furioso', emoji: '😤' },
    ...
    sweat: { aliases: ['sudar', 'nervioso'], support: OTAKUGIFS_ONLY, label: 'sudor', emoji: '💦' },
    ...
    boop: { aliases: ['tocar-nariz', 'boop'], support: HMTAI_ONLY, label: 'boop', emoji: '👉👃' },
    ...
    embarrassed: { aliases: ['avergonzado', 'nervioso', 'turbado'], support: ANIMEREACTIONS_ONLY, label: 'verguenza', emoji: '😳' },
    dumb: { aliases: ['tonto', 'idiota', 'estupido', 'dumb'], support: ANIMEREACTIONS_ONLY, label: 'tonto', emoji: '🤪' },
    lunch: { aliases: ['almuerzo', 'comer', 'hora-de-comer'], support: ANIMEREACTIONS_ONLY, label: 'almuerzo', emoji: '🍱' },
    ...
    facepalm: { aliases: ['facepalm', 'disappointed', 'dios-mio'], support: ['nekosbest', 'kyoko', 'otakugifs'], label: 'facepalm', emoji: '🤦' },
    ...
    baka: { aliases: ['idiota', 'tonto', 'baka'], support: ['nekosbest', 'hmtai'], label: 'insulto', emoji: '🐄' },
};
